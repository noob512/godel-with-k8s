...
require (
	...
	github.com/kubewharf/katalyst-api v0.4.1-0.20240222122824-be538f641f58 // indirect
...
replace github.com/kubewharf/godel-scheduler => G:/git/reduced-godel-scheduler-my-reduced
